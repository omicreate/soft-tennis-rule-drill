(() => {
  const SOURCES = [
    {
      id: "jsta-rulebook-20260401",
      rank: "A",
      title: "ソフトテニスルールブック（2026年4月1日発行）",
    ...
    {
      id: "shizuoka-2026-minutes",
      rank: "B",
      title: "2026年度 第1回常任理事会議事録",
  ...
  globalThis.SOFT_TENNIS_REFEREE_SOURCES = SOURCES;
})();
